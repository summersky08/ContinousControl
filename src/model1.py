...
def policy_evaluate(V, policy, num_iter=10):
            ...
            for j in range(V.shape[1]):
                ...
                for k in range(V.shape[2]):
                    ...
                    for ai in range(V.shape[3]):
                        ...
                        p0 = step(G, p.copy(), 1, 0, 0, i2u(ui), 0, a, random=False)
                        i2,j2,k2 = p2i(p0)
                        i2, j2 = np.minimum(pimax[:-1], [i2, j2])
                        i2, j2 = np.maximum([0,0], [i2,j2])

                        V2[i, j, k, ai] = stage_cost + gamma * V[i2,j2,k2,ai]
                ...
                for ai in range(V.shape[3]):
                    ...
                    for ui1 in range(uimax[0]+1):
                        for ui2 in range(uimax[1]+1):
                            ...
                            p0 = step(G, p.copy(), 1, 0, 0, u, 0, a, random=False)
                            #print(p, p0)
                            ...
                            expected_value = V[i2, j2, k2, ai]

                            #print(expected_value, ui,(i, j,k),(i2, j2,k2))
